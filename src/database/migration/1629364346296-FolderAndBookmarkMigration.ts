...
export class FolderAndBookmarkMigration1629364346296 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bookmark" ("id" character varying NOT NULL, "name" text NOT NULL, "url" text NOT NULL, "isFavorite" boolean NOT NULL DEFAULT false, "description" text, "imageUrl" text, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP, "deletedAt" TIMESTAMP, "userId" character varying, "folderId" character varying, CONSTRAINT "PK_b7fbf4a865ba38a590bb9239814" PRIMARY KEY ("id"))`);
